...
def switch_theme(n:int):
    ...
    cur_color1=int(color_themes[n]["colors_current"]["fg1"])
    cur_color2=int(color_themes[n]["colors_current"]["fg2"])
    cur_color_bk1=int(color_themes[n]["colors_current"]["bk1"])
    cur_color_bk2=int(color_themes[n]["colors_current"]["bk2"])
    cur_color_s=int(color_themes[n]["colors_current"]["fg_upper"])
    cur_color_s_bold=int(color_themes[n]["colors_current"]["fg_upper_bold"])
    cur_color_bk_s=int(color_themes[n]["colors_current"]["bk_upper"])
    cur_theme_idx=n
...
def save_theme(n:int):
    global color_themes
    color_themes[n]["colors_current"]["fg1"]=str(cur_color1)
    color_themes[n]["colors_current"]["fg2"]=str(cur_color2)
    color_themes[n]["colors_current"]["bk1"]=str(cur_color_bk1)
    color_themes[n]["colors_current"]["bk2"]=str(cur_color_bk2)
    color_themes[n]["colors_current"]["fg_upper"]=str(cur_color_s)
    color_themes[n]["colors_current"]["fg_upper_bold"]=str(cur_color_s_bold)
    color_themes[n]["colors_current"]["bk_upper"]=str(cur_color_bk_s)
